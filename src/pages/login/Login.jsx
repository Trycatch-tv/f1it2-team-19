...
export default function Login () {
  return (
    <section className="w-screeem min-h-screen grid place-content-center bg-backgroud">
     <div className="w-[364px] h-[326px] py-16 bg-soft_color border-2 border-border_color rounded-lg flex flex-col gap-5 items-center ">
      ...
      <button className="w-[300px] py-2 uppercase bg-primary rounded-lg text-soft_color font-light text-sm">Iniciar Sesión</button>
     </div>
    </section>
  )
}
